...
class BookReviewAPITestCase(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create(username="sukhrob", first_name="sukhrob")
        self.user.set_password("somepass")
        self.user.save()
        self.client.login(username="sukhrob", password="somepass")
    ...
    def test_book_review_detail(self):
        ...
        self.assertEqual(response.data['user']['first_name'], "sukhrob")
        self.assertEqual(response.data['user']['username'], "sukhrob")
